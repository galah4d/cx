...
```
cx lib/cxfx/src/argv.cx tests/main.cx ++wdir=tests
```
...
```
cx lib/cxfx/src/argv.cx tests/main.cx ++wdir=tests ++disable-tests=issue
```
...
```
cx lib/cxfx/src/argv.cx tests/main.cx ++wdir=tests ++log=fail,skip
```
