...
func init() {
	...
	// openal
	AddConstCode(CONST_AL_INVALID_NAME, "al.InvalidName", TYPE_I32, FromI32(0xA001))
	AddConstCode(CONST_AL_INVALID_ENUM, "al.InvalidEnum", TYPE_I32, FromI32(0xA002))
	AddConstCode(CONST_AL_INVALID_VALUE, "al.InvalidValue", TYPE_I32, FromI32(0xA003))
	AddConstCode(CONST_AL_INVALID_OPERATION, "al.InvalidOperation", TYPE_I32, FromI32(0xA004))
	AddConstCode(CONST_AL_OUT_OF_MEMORY, "al.OutOfMemory", TYPE_I32, FromI32(0xA005))
	AddConstCode(CONST_AL_INVERSE_DISTANCE, "al.InverseDistance", TYPE_I32, FromI32(0xD001))
	AddConstCode(CONST_AL_INVERSE_DISTANCE_CLAMPED, "al.InverseDistanceClamped", TYPE_I32, FromI32(0xD002))
	AddConstCode(CONST_AL_LINEAR_DISTANCE, "al.LinearDistance", TYPE_I32, FromI32(0xD003))
	AddConstCode(CONST_AL_LINEAR_DISTANCE_CLAMPED, "al.LinearDistanceClamped", TYPE_I32, FromI32(0xD004))
	AddConstCode(CONST_AL_EXPONENT_DISTANCE, "al.ExponentDistance", TYPE_I32, FromI32(0xD005))
	AddConstCode(CONST_AL_EXPONENT_DISTANCE_CLAMPED, "al.ExponentDistanceClamped", TYPE_I32, FromI32(0xD006))
	AddConstCode(CONST_AL_INITIAL, "al.Initial", TYPE_I32, FromI32(0x1011))
	AddConstCode(CONST_AL_PLAYING, "al.Playing", TYPE_I32, FromI32(0x1012))
	AddConstCode(CONST_AL_PAUSED, "al.Paused", TYPE_I32, FromI32(0x1013))
	AddConstCode(CONST_AL_STOPPED, "al.Stopped", TYPE_I32, FromI32(0x1014))
	AddConstCode(CONST_AL_FORMAT_MONO_8, "al.FormatMono8", TYPE_I32, FromI32(0x1100))
	AddConstCode(CONST_AL_FORMAT_MONO_16, "al.FormatMono16", TYPE_I32, FromI32(0x1101))
	AddConstCode(CONST_AL_FORMAT_STEREO_8, "al.FormatStereo8", TYPE_I32, FromI32(0x1102))
	AddConstCode(CONST_AL_FORMAT_STEREO_16, "al.FormatStereo16", TYPE_I32, FromI32(0x1103))
	AddConstCode(CONST_AL_WAV_FORMAT_PCM, "al.WavFormatPCM", TYPE_I32, FromI32(1))
	AddConstCode(CONST_AL_WAV_FORMAT_IEEE_FLOAT, "al.WavFormatIEEEFloat", TYPE_I32, FromI32(3))
